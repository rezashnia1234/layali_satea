...
myApp.onPageInit('no-game', function (page) {
	...
	$$("#no_quiz_description_l1").html(ajax_result.no_quiz_description_l1);
	$$("#no_quiz_description_l2").html(ajax_result.no_quiz_description_l2);
});
myApp.onPageInit('game_page', function (page) {
	...
	if(next_question.a!=undefined && next_question.a!="")
	{
		...
		html += '		<input type="radio" name="answer" value="1" />';
		html += '		<div class="item-media"><i class="icon icon-form-radio"></i></div>';
		html += '		<div class="item-inner">';
		html += '			<div class="item-title">' + next_question.a + '</div>';
		html += '		</div>';
		html += '	</label>';
		html += '</li>';
		$$("#question_answers").append(html);
	}
	if(next_question.b!=undefined && next_question.b!="")
	{
		var html = "";
		html += '';
		html += '<li>';
		html += '	<label class="label-radio item-content">';
		html += '		<input type="radio" name="answer" value="2" />';
		html += '		<div class="item-media"><i class="icon icon-form-radio"></i></div>';
		html += '		<div class="item-inner">';
		html += '			<div class="item-title">' + next_question.b + '</div>';
		html += '		</div>';
		html += '	</label>';
		html += '</li>';
		$$("#question_answers").append(html);
	}
	if(next_question.c!=undefined && next_question.c!="")
	{
		var html = "";
		html += '';
		html += '<li>';
		html += '	<label class="label-radio item-content">';
		html += '		<input type="radio" name="answer" value="3" />';
		html += '		<div class="item-media"><i class="icon icon-form-radio"></i></div>';
		html += '		<div class="item-inner">';
		html += '			<div class="item-title">' + next_question.c + '</div>';
		html += '		</div>';
		html += '	</label>';
		html += '</li>';
		$$("#question_answers").append(html);
	}
	if(next_question.d!=undefined && next_question.d!="")
	{
		var html = "";
		html += '';
		html += '<li>';
		html += '	<label class="label-radio item-content">';
		html += '		<input type="radio" name="answer" value="4" />';
		html += '		<div class="item-media"><i class="icon icon-form-radio"></i></div>';
		html += '		<div class="item-inner">';
		html += '			<div class="item-title">' + next_question.d + '</div>';
		html += '		</div>';
		html += '	</label>';
		html += '</li>';
		$$("#question_answers").append(html);
	}
	if(next_question.e!=undefined && next_question.e!="")
	{
		var html = "";
		html += '';
		html += '<li>';
		html += '	<label class="label-radio item-content">';
		html += '		<input type="radio" name="answer" value="5" />';
		html += '		<div class="item-media"><i class="icon icon-form-radio"></i></div>';
		html += '		<div class="item-inner">';
		html += '			<div class="item-title">' + next_question.e + '</div>';
		html += '		</div>';
		html += '	</label>';
		html += '</li>';
		$$("#question_answers").append(html);
...
myApp.onPageInit('before_game', function (page) {
	var clock;
	...
	// var futureDate  = new Date(currentDate.getFullYear(), 1, 1);

	// Calculate the difference in seconds between the future and current date
	// var diff = futureDate.getTime() / 1000 - currentDate.getTime() / 1000;

	// Instantiate a coutdown FlipClock
	if(quiz_starting_time==undefined)
	{
		setTimeout(function(){
			// mainView.router.loadPage('index.html');
			mainView.refreshPage();
		}, 2000);
		console.log(quiz_starting_time);
		return true;
	}
	
	clock = $('.digits.active').FlipClock(quiz_starting_time, {
		...
		callbacks: {
			...
			start: function() {
				var total_width = 0;
				$('.digits.active > *').each(function(i, obj) {
					total_width += $(obj).outerWidth() + 7;
				});
				// console.log(total_width);
				$('.digits.active').css("width",total_width + "px");
			}
		}
	});
